...
- [Material Assignment](#material-assignment)
  ...
  - [Material Fallback Logic](#material-fallback-logic)
...
Loads the mesh-to-material mapping dictionary from `mesh_material_mapping.json`:
...
**Required File:** `res://shaders/mesh_material_mapping.json`

This file is generated by the Python `material_list.py` module from `MaterialList.txt` files found in the SourceFiles folder.
...
The `_try_material_fallbacks()` function handles common naming mismatches:
